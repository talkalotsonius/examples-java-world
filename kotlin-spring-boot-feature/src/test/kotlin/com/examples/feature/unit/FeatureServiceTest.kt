package com.examples.feature.unit
...
import com.examples.feature.util.FeatureFaker
...
class FeatureServiceTest {
    ...
    private fun ByteArray.convertToString() = Base64.getEncoder().encodeToString(this)
}
